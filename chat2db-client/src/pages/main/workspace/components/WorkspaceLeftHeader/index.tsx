...
export default memo<IProps>((props) => {
  ...
  const renderConnectionLabel = (item: {
    id: number;
    alias: string;
    type: string;
  }) => {
    return <div className={classnames(styles.menuLabel)}>
      <Tag className={styles.menuLabelTag} color='blue'>开发</Tag>
  ...
  return <div className={classnames(styles.workspaceLeftHeader, className)}>
