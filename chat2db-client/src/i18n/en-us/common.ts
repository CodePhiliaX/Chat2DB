export default {
  ...
  'common.viewAllTable.batchOptimize': 'Batch Optimize Tables',
  'common.viewAllTable.noSelectedTablesForOptimize': 'Please select tables to optimize first',
  'common.viewAllTable.batchOptimizeConfirmTitle': 'Confirm Batch Optimize Tables',
  'common.viewAllTable.batchOptimizeConfirmContent': 'Are you sure to execute OPTIMIZE TABLE on the selected {1} table(s)?',
  'common.viewAllTable.batchOptimizeSuccess': 'Successfully optimized {1} table(s)',
  'common.viewAllTable.batchOptimizePartialSuccess': 'Optimized {1} table(s) successfully, {2} failed',
  'common.viewAllTable.batchAnalyze': 'Batch Analyze Tables',
  'common.viewAllTable.noSelectedTablesForAnalyze': 'Please select tables to analyze first',
  'common.viewAllTable.batchAnalyzeConfirmTitle': 'Confirm Batch Analyze Tables',
  'common.viewAllTable.batchAnalyzeConfirmContent': 'Are you sure to execute ANALYZE TABLE on the selected {1} table(s)?',
  'common.viewAllTable.batchAnalyzeSuccess': 'Successfully analyzed {1} table(s)',
  'common.viewAllTable.batchAnalyzePartialSuccess': 'Analyzed {1} table(s) successfully, {2} failed',
};
