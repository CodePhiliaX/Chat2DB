export default {
  ...
  'common.text.allTablesHaveComments': '所有表已有注释，无需生成',
  ...
  'common.viewAllTable.batchOptimize': '批量优化表',
  'common.viewAllTable.noSelectedTablesForOptimize': '请先选择要优化的表',
  'common.viewAllTable.batchOptimizeConfirmTitle': '确认批量优化表',
  'common.viewAllTable.batchOptimizeConfirmContent': '确定要对选中的 {1} 张表执行 OPTIMIZE TABLE 吗？',
  'common.viewAllTable.batchOptimizeSuccess': '成功优化 {1} 张表',
  'common.viewAllTable.batchOptimizePartialSuccess': '成功优化 {1} 张表，失败 {2} 张表',
  'common.viewAllTable.batchAnalyze': '批量分析表',
  'common.viewAllTable.noSelectedTablesForAnalyze': '请先选择要分析的表',
  'common.viewAllTable.batchAnalyzeConfirmTitle': '确认批量分析表',
  'common.viewAllTable.batchAnalyzeConfirmContent': '确定要对选中的 {1} 张表执行 ANALYZE TABLE 吗？',
  'common.viewAllTable.batchAnalyzeSuccess': '成功分析 {1} 张表',
  'common.viewAllTable.batchAnalyzePartialSuccess': '成功分析 {1} 张表，失败 {2} 张表',
};
