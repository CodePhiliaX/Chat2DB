export default {
  ...
  'workspace.savedConsole.importSql': 'SQL dosyası içe aktar',
  'workspace.savedConsole.exportSql': 'SQL dosyası dışa aktar',
  'workspace.savedConsole.import.success': 'SQL dosyası içe aktarıldı',
  'workspace.savedConsole.import.emptyFile': 'SQL dosyası boş',
  'workspace.savedConsole.import.onlySql': 'Yalnızca .sql dosyaları içe aktarılabilir',
  ...
  'workspace.tips.affirmDeleteTable':
    'Girdiğiniz tablo adı, silmek istediğiniz tablo adı ile aynı değil, lütfen tekrar doğrulayın',
  'workspace.erDiagram.inferVirtualFk': 'Sanal FK Tahmin Et',
  'workspace.erDiagram.inferVirtualFkNoResult': 'Yeni sanal yabancı anahtar bulunamadı',
  'workspace.erDiagram.inferVirtualFkError': 'Sanal yabancı anahtarlar tahmin edilemedi',
  'workspace.erDiagram.inferResult.title': 'Sanal FK Tahmin Sonucu',
  'workspace.erDiagram.inferResult.added': 'Eklendi ({1})',
  'workspace.erDiagram.inferResult.deleted': 'Kaldırıldı ({1})',
