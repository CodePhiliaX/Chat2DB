export default {
  ...
  'workspace.savedConsole.importSql': 'SQLファイルをインポート',
  'workspace.savedConsole.exportSql': 'SQLファイルをエクスポート',
  'workspace.savedConsole.import.success': 'SQLファイルをインポートしました',
  'workspace.savedConsole.import.emptyFile': 'SQLファイルが空です',
  'workspace.savedConsole.import.onlySql': '.sqlファイルのみインポートできます',
  ...
  'workspace.tree.delete.database.tip': 'データベース{1}を削除してもよろしいですか？この操作は元に戻せません。',
