...
public class ResultSetUtils {
    ...
    public static ai.chat2db.server.domain.support.model.Function buildFunction(ResultSet resultSet) {
        ai.chat2db.server.domain.support.model.Function function
            = new ai.chat2db.server.domain.support.model.Function();
        try {
